    ...
    <div className="min-h-screen flex flex-col lg:flex-row bg-white">
      ...
      <div className="flex-1 flex items-center justify-center py-12 px-6 lg:px-12">
        <div className="w-full max-w-lg space-y-8">
          ...
          <Card className="relative overflow-hidden border border-primary-100 shadow-2xl bg-white/95 backdrop-blur-sm">
              ...
              {!import.meta.env.PROD && (
                <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                  <p className="text-sm text-yellow-800">
                    ...
                    persists between sessions. If you're seeing a logged-in
                    state unexpectedly, use the "Clear Auth" button in the
                    header.
                  </p>
                </div>
              )}
